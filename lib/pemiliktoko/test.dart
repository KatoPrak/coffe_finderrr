    ...
    try {
      ...
      if (user != null) {
        ...
        setState(() {
          ...
          selectedGender = dataCustomerDoc['jenis kelamin'] ?? 'Jenis Kelamin';
          phoneController.text = dataCustomerDoc['phone'] ?? '';
          alamatController.text = dataCustomerDoc['alamat'] ?? '';
          currentPhotoUrl = dataCustomerDoc['foto'] ?? '';
        });
      }
    } catch (e) {
